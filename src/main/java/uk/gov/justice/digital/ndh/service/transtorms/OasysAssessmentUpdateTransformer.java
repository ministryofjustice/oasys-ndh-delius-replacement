...
public class OasysAssessmentUpdateTransformer {
    ...
    private OasysSupervisionPlan deliusSupervisionPlanOf(Objective objective, Assessment assessment) {
        return OasysSupervisionPlan.builder()
                ...
                .need2(Optional.ofNullable(descriptionOf(objective.getNeed2(), OASYS_CRMS_CRIM_NEED)).map(result -> result.substring(0, 50)).orElse(null))
                .need3(Optional.ofNullable(descriptionOf(objective.getNeed3(), OASYS_CRMS_CRIM_NEED)).map(result -> result.substring(0, 50)).orElse(null))
                .need4(Optional.ofNullable(descriptionOf(objective.getNeed4(), OASYS_CRMS_CRIM_NEED)).map(result -> result.substring(0, 50)).orElse(null))
                .objective(Optional.ofNullable(objective.getObjectiveDescription()).map(o -> o.substring(0, 50)).orElse(null))
                .objectiveStatus(Optional.ofNullable(descriptionOf(objective.getObjectiveStatus(), OASYSRCMS_OBJ_STATUS_CODE)).map(result -> result.substring(0, 50)).orElse(UNMAPPED))
                .workSummary1(Optional.ofNullable(descriptionOf(objective.getActionCode1(), OASYSRCMS_INTERVENTION)).map(result -> result.substring(0, 50)).orElse(null))
                .workSummary2(Optional.ofNullable(descriptionOf(objective.getActionCode2(), OASYSRCMS_INTERVENTION)).map(result -> result.substring(0, 50)).orElse(null))
                .workSummary3(Optional.ofNullable(descriptionOf(objective.getActionCode3(), OASYSRCMS_INTERVENTION)).map(result -> result.substring(0, 50)).orElse(null))
    ...
    private OasysAssessmentSummary deliusOasysAssessmentSummaryOf(Assessment ndhAssessment) {
        ...
        return OasysAssessmentSummary.builder()
                ...
                .purposeOfAssessmentDescription(ndhAssessment.getPurposeOfAssessmentDescription().substring(0, 50))
